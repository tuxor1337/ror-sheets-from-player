...
export default {
  'General Breaks': {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/37596e72-e93b-44f1-8770-760be8e5ce87',
    patterns: {
      'Karla Break': {
        ...
        ag: '@ls',
        sh: '@ls',
        volumeHack: { 0: 0.1, 16: 0.4, 32: 0.7, 48: 1 },
      },
      '8 up': {
  ...
  'Special Breaks': {
    ...
    patterns: {
      ...
      'Hardcore Break': {
        ...
        hs: '@ls',
        re:
          repeat(1, '              XXX             XXX             XXX       XXXXXXXX') +
          repeat(1, 'X   X   X   X XXX   X   X   X XXX   X   X   X XXX   X   XXXXXXXX') +
          repeat(2, 'X X X X X X X XXX X X X X X X XXX X X X X X X XXX X X X XXXXXXXX'),
        sn: '@re',
        ta: '@re',
        ag:
          repeat(3, 'o o o o o o o ooo o o o o o o ooo o o o o o o ooo o o o oooooooo') +
      ...
      'Hard Core Break': {
        ...
        re:
          repeat(1, '              XXX             XXX             XXX       XXXXXXXX') +
          repeat(3, 'X X X X X X X XXX X X X X X X XXX X X X X X X XXX X X X XXXXXXXX'),
        sn: '@re',
        ta: '@re',
        ag:
          repeat(3, 'o o o o o o o ooo o o o o o o ooo o o o o o o ooo o o o oooooooo') +
      ...
      'Nellie the Elephant Break': {
        ls:
          '            X X             X X             X X XX XX XX XX X X XX XX XX XX X X XX XX XX XX X X ' +
          repeat(2, '                ') +
          repeat(3, 'X  X  X         ') +
          'X           XXX ',
        ms: '@ls',
        hs: '@ls',
        re:
          'XX XX XX XX     XX XX XX XX     XX XX XX XX     XX XX XX XX X X XX XX XX XX X X XX XX XX XX X X ' +
          repeat(2, '                ') +
          repeat(3, '        X  X  X ') +
          'X           XXX ',
        sn: '@ls',
        ...
        ot:
          '                                                                                                ' +
          repeat(2, 'DDDDDDDDDDDDDDDD') +
          repeat(3, '                ') +
          '                ',
        volumeHack: Object.assign(
          { 48: 0.2, 64: 0.6, 80: 1, 128: 0.2, 144: 0.6, 160: 1 },
          crescendo(32, 96),
        ),
      },
      'Super Mario Break': {
  ...
  'Shouting Breaks': {
    ...
    patterns: {
      'Democracy Break': {
        ...
        ag: '@ls',
        ot: '                                                * , - ?: ;< = >                 * , - ?: ;< = >                 * , - ?: ;< = > * , - ?: ;< = > * , - ?: ;< = >                 ',
        volumeHack: { 0: 0.1, 16: 0.4, 32: 0.7, 48: 1, 112: 0.4, 128: 0.7, 144: 1 },
      },
      'Tout le monde': {
  ...
  'Angela Davis': {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/3a431ae3-e59b-4d31-b2d6-9abc4db3f242',
    patterns: {
      Tune: {
        loop: true,
        ls: 'r r X  XrXr X   ',
  ...
  Bhangra: {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/bb1e9a2e-ce51-435c-818f-d98cf95f9ed0',
    patterns: {
      Tune: {
        loop: true,
      ...
      'Karla Break (3⁄4)': {
        ...
        ag: '@ls',
        sh: '@ls',
        volumeHack: { 0: 0.1, 12: 0.4, 24: 0.7, 36: 1 },
      },
      '8 up (3⁄4)': {
  ...
  'Drum&Bass': {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/f5331b5e-5de7-41e9-af0f-813f874bb074',
    patterns: {
      Tune: {
        loop: true,
        ls: 'X         X  X  X         X     X         X  X  X         X     ',
  ...
  'Drunken Sailor': {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/00dd3ac1-a872-49ea-aec1-8c8ebc8f334e',
    patterns: {
      Tune: {
        loop: true,
        ls: 'X   X   X X     X   X   X X     X   X   X X             X   X   ',
  ...
  Hafla: {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/2fbb7d46-3399-4818-89aa-a5dc0b377238',
    patterns: {
      Tune: {
        loop: true,
        ls: 'X       X       X X     X       ',
  ...
  'Karla Shnikov': {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/cc4d0222-3713-4943-bba1-cc733cb84ccc',
    patterns: {
      Tune: {
        loop: true,
  ...
  Ragga: {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/bb2a4cd6-021b-4596-9917-f53bed8363a8',
    patterns: {
      Tune: {
        loop: true,
  ...
  'Rope Skipping': {
    ...
    patterns: {
      Tune: {
        ...
        ta:
          stretch(4, 12, 'X  XX   X  XX   X  XX  XX  XX   X  XX   X  XX   X  XX   ') +
          stretch(3, 12, 'XXX   '),
      ...
      'Eye of the tiger': {
        ...
        ag:
          stretch(4, 12, '                                                ') +
          'oaoaoaoaoaoaoaoaoaoaoaoaoaoaoaoaoaoaoaoaoaoaoaoa',
      },
    },
    exampleSong: [
      'Tune',
  ...
  'Samba Reggae': {
    ...
    patterns: {
      ...
      'Knock On The Door (Cut)': {
        ...
        re:
          stretch(3, 12, 'X        XXX') +
          stretch(4, 12, 'X               X  X  X   X X X X X XX X X X XX '),
        sn: repeat(4, stretch(4, 12, 'X..XX..XX..XX..X')),
        ta: '@ls',
        ag: '@ls',
        sh: '@ls',
  ...
  'Samba Reggae High': {
    ...
    patterns: {
      ...
      'Tam “Bossa Mess About”': {
        time: 12,
        ta:
          stretch(4, 12, 'X  X  X   X  X  X  X  X  XX  X  X  X  X  XX XX  X  X  X ') +
          stretch(3, 12, 'XXXXXX'),
      },
  ...
  'Samba Reggae Low': {
    ...
    patterns: {
      ...
      'Fancy Tam Line': {
        ta:
          repeat(2, 'X  X  X   X X   X  X  X   X X   ') +
          repeat(2, 'X  X  X   X X XXX  X  X XXX X   '),
      },
      'Fancy Tam Line 2': {
        ta:
          repeat(2, 'X  X  X         X  X  X         ') +
          repeat(2, 'X  X  X   XXX XXX  X  X         '),
      },
    },
    exampleSong: [
      'Tune',
  ...
  Sambasso: {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/f75a6a4e-121a-4170-aaf4-2e96a7eed95e',
    patterns: {
      Tune: {
        loop: true,
  ...
  'The Roof Is on Fire': {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/1c318897-e3b7-436b-b319-4608774169e0',
    patterns: {
      Tune: {
        loop: true,
        ls: '        X       X       X   X   X ',
  ...
  'Walc(z)': {
    ...
    patterns: {
      ...
      'Karla Break (6⁄4)': {
        ...
        ag: '@ls',
        sh: '@ls',
        volumeHack: { 0: 0.1, 24: 0.4, 48: 0.7, 72: 1 },
      },
      '8 up (6⁄4)': {
  ...
  Xango: {
    ...
    video:
      'https://tube.rhythms-of-resistance.org/videos/embed/ae1fe3a3-dd7e-4670-9415-b47ee60a54b0',
    patterns: {
      Tune: {
        loop: true,
        ls: repeat(2, 's   X XX        '),
