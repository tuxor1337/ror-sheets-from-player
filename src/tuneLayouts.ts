...
export default {
  'General Breaks': {
    ...
    patterns: {
      ...
      'Continue for Four Bars': {
        ...
        sign: 'like “continue for two bars” and then again in the opposite direction',
        nosqueeze: true,
      },
      'Boom Break': {
      ...
      'Wolf Break': {
        ...
        notes: ['S S A SSS S A  S' + 'S S A  SS S A   ' + 'S S A SSS S A  E' + 'E E E E         '],
        notes_override: [
          {
            60: [1, 'a', 'center'],
            61: [1, 'u', 'center'],
      ...
      '4 times from soft to loud': {
        ...
        sign:
          'Hold one arm vertically in front of your body and move the other' + ' up along the arm',
        subtitle_extra_lines: 1,
      },
      'Tamborim Stroke': {
        text: {
      ...
      'Play another instrument': {
        ...
        sign: 'Hold both hands in front of your face, and wave your arms to cross' + ' each other',
        subtitle_extra_lines: 1,
      },
      ...
      'Storming Break': {
        ...
        sign: "show the arm as a measure with the other hand on elbow don't make a fist",
        subtitle_extra_lines: 1,
      },
      ...
      'Chaos Break': {
        text: {
          content:
            'Everyone plays something chaotic, getting louder and louder.' + ' No counting in!',
          rows: 2,
        },
  ...
  Afoxe: {
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Break 3', 'Bra Break']],
  },
  'Angela Davis': {
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Break 3']],
  },
  'Angry Dwarfs': {
    ...
    pages: [['Tune', 'Intro', 'No-Cent-For-Axel-Break', 'Tension Break']],
  },
  Antitek: {
    sign:
    ...
    patterns: {
      ...
      'Singing Break 1': {
        // DIFFERENCE: missing in player
        notes: ['X  X  X           XXX X X       ' + 'X  X  X           XXX X X       '],
        notes_override: [
          {
            1: [1, 'non', 'left'],
            4: [1, 'non', 'left'],
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Call Break', 'Singing Break 1', 'Singing Break 2']],
  },
  'Bella Ciao': {
    sign:
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Break 3', 'Intro']],
  },
  Bhangra: {
    ...
    patterns: {
      ...
      'Break 2': {
        memory_aid: {
          upbeat: 6,
          notes: '  XX  ' + 'X XX  X XX  X       XX  ' + '  X  XX  X  X       XX  ',
          words: [
            'I',
            'want',
            'pa-',
    ...
    pages: [
      ['Tune', 'Break 1'],
      ['Break 2', 'Break 3', 'Bra Break'],
    ],
  },
  Bomba: {
    sign: 'As you grab a hand granade, take the secure with your mouth and throw it to the air.',
    patterns: {
      'Break 2': {
        notes: {
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Call Break']],
  },
  Chichita: {
    ...
    patterns: {
      Tune: {
        notes: {
          ...
          'Snare 2':
            'ffX ffX ffXXX X ' + 'ffX ffX ffXXX X ' + 'ffX ffX ffXXX X ' + 'X XXX X XXXXX X ',
        },
        merge_instruments: {
          'Snare 1': ['sn'],
        },
        instru_order: ['ls', 'ms', 're', 'Snare 1', 'Snare 2', 'ag'],
      },
      'Double Break 2': {
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Double Break 2', 'Intro', 'End', 'Background']],
  },
  'Coupe-Decale': {
    sizing: {
      pre_width: 12,
    ...
    patterns: {
      Tune: {
        ...
        instru_order: ['ls', 'mhs', 'Repi & Snare', 'ta', 'ag'],
      },
      'Tune (6/8)': {
        name: 'Groove (6/8)',
      },
      ...
      'Break 1': {
        ...
        separate_lines: [[0, 48, ['ag']]],
      },
    },
    pages: [
      ['Tune', 'Intro', 'Break 1'],
      ['Break 2', 'Tune (6/8)', 'Intro (6/8)', 'Crest Break (6/8)'],
    ],
  },
  Cochabamba: {
    ...
    pages: [['Tune', 'Break 1', 'Bra Break (Maestra)', 'Cross Kicks']],
  },
  Custard: {
    ...
    patterns: {
      ...
      'Break 3': {
        preamble: 'ONE instrument section continues while the rest of the band plays this break',
        sign: '+ instr. sign that continues',
        separate_lines: [[112, 127, ['sn']]],
      },
      'Singing Break': {
        notes: ['                ' + '                ' + '                ' + '                '],
        notes_override: Object.assign(
          {},
          ...[0, 16, 32, 48].map((offset) =>
            shift_override_offsets(
              {
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Break 3', 'Break 5', 'Singing Break']],
  },
  'Crazy Monkey': {
    ...
    pages: [
      ['Tune', 'Break 1'],
      ['Break 2', 'Break 3', 'Bongo Break 1', 'Bongo Break 2', 'Monkey Break'],
    ],
  },
  'Drum&Bass': {
    ...
    patterns: {
      ...
      'Hip-Hop Break': {
        sign: 'hit your chest',
        remarks_indent: 0,
        remarks: ['R = hit on repi,' + ' ri = repi hit on rim,' + ' sn = snare,'],
      },
    },
    pages: [['Tune', 'Dance Break', 'Break 2', 'Break 3', 'Hip-Hop Break']],
  },
  'Drunken Sailor': {
    ...
    patterns: {
      'White Shark': {
        ...
        separate_lines: [[0, 127, ['ag']]],
      },
    },
    pages: [['Tune', 'Break 1', 'Break 2', 'White Shark']],
  },
  Funk: {
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Oi/Ua Break']],
  },
  Hafla: {
    ...
    patterns: {
      ...
      Tune: {
        ...
        instru_order: ['ls', 'ms', 'hs', 're', 'sn', 'Snare (easier)', 'ta', 'ag'],
      },
      'Yala Break': {
      ...
      'Kick Back 1': {
        single_bar_sizing: true,
        suppress_instruments: [['*', 17, 64]],
        separate_lines: [[0, 15, ['ag']]],
        remarks_indent: 0,
        remarks: ['repeat until cut, ag = Agogô, switch low and high every two bars'],
      },
      'Kick Back 2': {
        notes_override: [
          {
        ...
        remarks_indent: 0,
        remarks: ['. = snare playing silent note'],
      },
      'Hook Break': {
    ...
    pages: [['Tune', 'Yala Break', 'Kick Back 1', 'Kick Back 2', 'Break 3', 'Hook Break']],
  },
  Hedgehog: {
    ...
    patterns: {
      ...
      'Break 1': {
        ...
        remarks_indent: 16,
        remarks: ['others continue playing'],
      },
      'Break 2': {
        name: 'Hedgehog Call',
        notes: ['                ' + 'E               '],
        ...
        subtitle_extra_lines: 1,
        remarks_indent: 24,
        remarks: ['call something else here'],
      },
    },
    pages: [['Tune', 'Break 1', 'Break 2']],
  },
  'Hip Hop': {
    ...
    patterns: {
      ...
      'Break 1': {
        remarks_indent: 0,
        remarks: ['(Count in break 1 for the second measure)'],
      },
    },
    pages: [['Tune', 'Kick Back 1', 'Kick Back 2', 'Break 1']],
  },
  Jungle: {
  ...
  'Karla Shnikov': {
    ...
    patterns: {
      'Karla Break': {
        ...
        notes: ['XXXXXXXXXXXXXXXX' + 'XXXXXXXXXXXXXXXX' + 'XXXXXXXXXXXXXXXX' + 'X               '],
    ...
    pages: [['Tune', 'Karla Break', 'Break 2', 'Break 2 Inverted']],
  },
  'Malkhas Akhber': {
    sign:
      'put one fist on top of the other, as if you were' + ' holding a paddle, and start paddling',
    patterns: {
      'Hey Break': {
        notes: ['XX  r           '],
        notes_override: [
  ...
  'March for Biodiversity': {
    ...
    pages: [['Tune', 'Intro', 'Break 1', 'Break 2']],
  },
  'No Border Bossa': {
    ...
    patterns: {
      Tune: {
        ...
        remarks: ['Surdos: only 1 Stick on one hand; h = other hand hits skin'],
      },
      'Break 2': {
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Break 2*', 'Bra Break']],
  },
  Menaiek: {
    ...
    patterns: {
      'Double Break': {
        ...
        remarks: [
          'Like the groove, but double speed.' + ' Everyone else continues playing normally',
        ],
      },
      'Kick Back 1': {
        single_bar_sizing: true,
      ...
      'Mozambique Break': {
        ...
        sign: 'Point both index fingers away from mouth (like bug antennas)',
        remarks: ['sl = slap with thumb (by rotating the hand)'],
      },
    },
    pages: [
      ['Tune', 'Break 1', 'Break 2'],
      ['Double Break', 'Kick Back 1', 'Mozambique Break'],
    ],
  },
  Norppa: {
    // DIFFERENCE no sign?!
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Break 3', 'Call break', 'Shouting break', 'Break 5']],
  },
  'Nova Balanca': {
    ...
    pages: [['Tune', 'Bra Break', 'Break 1', 'Break 2']],
  },
  Orangutan: {
    ...
    patterns: {
      'Funky gibbon': {
        ...
        remarks: ['Repeat until cut', 'ri = Everyone else hits the rim'],
      },
      'Monkey break': {
        notes_override: [
          {
    ...
    pages: [['Tune', 'Funky gibbon', 'Monkey break', 'Break 2', 'Speaking Break']],
  },
  Pekurinen: {
    // DIFFERENCE no sign?!
    sizing: {
    ...
    pages: [
      ['Tune', 'Break 1', 'Break 2', 'Break 3', 'Clave Plus', 'Disco Barricade Break', 'Bra Break'],
    ],
  },
  'Rope Skipping': {
    ...
    patterns: {
      ...
      'Eye of the tiger': {
        separate_lines: [[0, 189, ['sn']]],
        preamble: 'Surdos (High, Middle, Low), Snare',
        sign: 'claws left and right',
      },
    },
    pages: [
      ['Tune', 'Oh Shit', 'Fuck Off', 'Break 1', 'Break 2', 'Break 3'],
      ['Küsel Break', 'Skipping Agogo', 'I like to move it', 'Eye of the tiger'],
    ],
  },
  Ragga: {
    ...
    patterns: {
      ...
      'Zorro-Break': {
        remarks_indent: 0,
        remarks: ['others continue playing;' + ' repeat until cut with one of the breaks'],
        sign: "sign 'Z' in the air",
        subtitle_extra_lines: 1,
      },
    },
    pages: [['Tune', 'Kick Back 1', 'Kick Back 2', 'Break 1', 'Break 2', 'Break 3', 'Zorro-Break']],
  },
  Sambasso: {
  ...
  'Samba Reggae': {
    ...
    patterns: {
      ...
      'Break 3': {
        suppress_instruments: [['sn', 17, 128]],
        nosqueeze: true,
        preamble: 'snare continues playing this through the break',
        remarks_indent: 0,
        remarks: ['hs = high surdo picks up'],
        separate_lines: [[80, 111, ['ta', 'ag']]],
      },
      'SOS Break': {
      ...
      'SOS Break (Repi change)': {
        name: '',
        preamble: 'after which the repinique picks up this rhythm' + ' and plays in the tune:',
        notes: ['  xx xx   x x   '],
      },
      'SOS Break (Repi change back)': {
        name: '',
        preamble: '... until next time the SOS break is played.' + ' Then it goes back to:',
        notes: ['  xx  xx  xx  xx'],
      },
      'Knock On The Door (Cut)': {
        name: 'Knock On The Door Break',
        preamble: 'snare continues playing this or the rhythm of Call Break',
        sign: 'knock with the knuckles of your right hand on your' + ' flat left hand',
        remarks_indent: 0,
        remarks: [
          'repeat until cut',
    ...
    pages: [
      ['Tune', 'Bra Break', 'Clave', 'Break 1', 'Break 2'],
      [
        'Break 3',
        'SOS Break',
        'SOS Break (Repi change)',
  ...
  'Sheffield Samba Reggae': {
    ...
    patterns: {
      Tune: {
        memory_aid: {
          notes: '  X X X XX XX X ',
          words: ['I', 'like', 'to', 'play', 'the', 'A-', 'go-', 'gô'],
        },
      },
      Intro: {
      ...
      Outro: {
        sign: 'Fist like “Stop playing” with thumb sticking out',
        remarks_indent: 0,
        remarks: ['then stop playing'],
      },
    },
    pages: [['Tune', 'Intro', 'Break 1', 'Break 2', 'Break 3', 'Whistle Break', 'Outro']],
  },
  Police: {
    sign:
    ...
    pages: [['Tune', 'Intro', 'Break 1', 'Break 2', 'Beast Break', 'Beast Break Inverted']],
  },
  Tequila: {
    ...
    pages: [['Tune', 'Break 1', 'Break 2', 'Bra Break']],
  },
  'The Roof Is on Fire': {
  ...
  'The Sirens of Titan': {
    ...
    patterns: {
      'Rented a Tent Break': {
        ...
        memory_aid: {
          notes: 'XXXX XX XX  XXXX XX XX  ' + 'XXXX  XXXX  XXXX  XXXX  ',
          words: [
            'Ren-',
            'ted',
            'a',
    ...
    pages: [['Tune', 'Rented a Tent Break']],
  },
  'Trans-Europa-Express': {
    ...
    pages: [['Tune', 'Doppler Break', 'Break 1']],
  },
  'Van Harte Pardon': {
  ...
  Wolf: {
    ...
    pages: [['Tune', 'Pat 1', 'Break 1', 'Break 2']],
  },
  Xango: {
    ...
    pages: [['Tune', 'Intro', 'Intro+Surdos', 'Boum Shakala Break', 'Break 2']],
  },
  'Zurav Love / Truant': {
    ...
    patterns: {
      'Bra Break': {
        single_bar_sizing: true,
        separate_lines: [[48, 63, ['sn']]],
      },
      'Kick Back 2': {
        separate_lines: [[0, 15, ['as', 'sn', 'ta', 'ag']]],
      },
    },
    pages: [['Tune', 'Bra Break', 'Kick Back 1', 'Kick Back 2']],
  },
}
